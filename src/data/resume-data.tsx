...
      techStack: ["FastAPI", "CLIP", "ORB", "Perception Encoder", "FAISS"],

      description:

        "Enhanced Visual Search API with Multi-Model Architecture: Developed a production-grade FastAPI service implementing dual search pipelines: (1) A two-stage approach combining CLIP embeddings with ORB/RANSAC reranking, and (2) Meta’s Perception Encoder for high-precision similarity search. Features include sophisticated caching mechanisms, API key authentication, dynamic dataset loading, and extensive logging. The system achieves fast retrieval times through FAISS indexing and optimized model loading, with built-in error handling and resource management for production reliability.",
